...
CSRF_TRUSTED_ORIGINS = [
    'https://project-django-production.up.railway.app',
]
...
SESSION_COOKIE_SECURE = True # for production purpose only 
# SESSION_COOKIE_SECURE = not DEBUG # for development only here.
